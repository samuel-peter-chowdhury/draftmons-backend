...
export function registerRepositories(): void {
  ...
  Container.set('ItemRepository', AppDataSource.getRepository(Item));
  ...
  Container.set('NatureRepository', AppDataSource.getRepository(Nature));
  ...
  Container.set('SeasonPokemonTeamRepository', AppDataSource.getRepository(SeasonPokemonTeam));
  ...
  Container.set('TeamBuildRepository', AppDataSource.getRepository(TeamBuild));
  Container.set('TeamBuildSetRepository', AppDataSource.getRepository(TeamBuildSet));
