...
import { TeamBuildController } from './controllers/team-build.controller';
import { TeamBuildService } from './services/team-build.service';
import { TeamBuildSetController } from './controllers/team-build-set.controller';
...
import { isAdmin, isAuthenticated, isAuthReadAdminWrite, isAuthReadLeagueModWrite } from './middleware/auth.middleware';
...
export class App {
  ...
  private teamBuildSetService: TeamBuildSetService;
  ...
  private async initializeServices(): Promise<void> {
    ...
    this.natureService = Container.get(NatureService);
    ...
    this.teamBuildService = Container.get(TeamBuildService);
    this.teamBuildSetService = Container.get(TeamBuildSetService);
...
`);
  ...
  private async initializeControllers(): Promise<void> {
    ...
    const natureController = new NatureController(this.natureService);
    ...
    const teamBuildController = new TeamBuildController(this.teamBuildService);
    const teamBuildSetController = new TeamBuildSetController(this.teamBuildSetService);
    ...
    this.app.use('/api/item', isAuthReadAdminWrite, itemController.router);
    ...
    this.app.use('/api/nature', isAuthReadAdminWrite, natureController.router);
    ...
    this.app.use('/api/team-build', isAuthenticated, teamBuildController.router);
    this.app.use('/api/team-build-set', isAuthenticated, teamBuildSetController.router);
