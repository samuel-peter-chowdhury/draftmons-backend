...
export class InitialSchema1746640225750 implements MigrationInterface {
    name = 'InitialSchema1746640225750'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "type_effective" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "pokemon_id" integer NOT NULL, "pokemon_type_id" integer NOT NULL, "value" double precision NOT NULL, CONSTRAINT "PK_6fc97ef5c90133902931d8094ef" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "pokemon_type" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "color" character varying NOT NULL, CONSTRAINT "PK_9975e2038d190b4ac724d1f553d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "move" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "pokemon_type_id" integer NOT NULL, "category" character varying NOT NULL, "power" integer NOT NULL, "accuracy" integer NOT NULL, "priority" integer NOT NULL, "pp" integer NOT NULL, "description" character varying NOT NULL, CONSTRAINT "PK_0befa9c6b3a216e49c494b4acc5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "generation" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, CONSTRAINT "PK_58db1b8155c99c2604394ffef2a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "pokemon_move" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "pokemon_id" integer NOT NULL, "move_id" integer NOT NULL, "generation_id" integer NOT NULL, CONSTRAINT "PK_1f944675e50c048fa1d0ab931e5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "ability" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "description" character varying NOT NULL, CONSTRAINT "PK_5643559d435d01ec126981417a2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "pokemon" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "dex_id" integer NOT NULL, "name" character varying NOT NULL, "hp" integer NOT NULL, "attack" integer NOT NULL, "defense" integer NOT NULL, "special_attack" integer NOT NULL, "special_defense" integer NOT NULL, "speed" integer NOT NULL, "base_stat_total" integer NOT NULL, "height" integer NOT NULL, "weight" integer NOT NULL, CONSTRAINT "PK_0b503db1369f46c43f8da0a6a0a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "match" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "week_id" integer NOT NULL, CONSTRAINT "PK_92b6c3a6631dd5b24a67c69f69d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "game" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "match_id" integer NOT NULL, "winning_team_id" integer NOT NULL, "differential" integer NOT NULL, "replay_link" character varying, CONSTRAINT "PK_352a30652cd352f552fef73dec5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "game_stat" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "game_id" integer NOT NULL, "season_pokemon_id" integer NOT NULL, "direct_kills" integer NOT NULL DEFAULT '0', "indirect_kills" integer NOT NULL DEFAULT '0', "deaths" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_10f89c0eac30c7d0106a13a3009" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "week" ("id" SERIAL NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "season_id" integer NOT NULL, CONSTRAINT "PK_1f85dfadd5f363a1d0bce2b9664" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "pokemon_pokemon_types" ("pokemon_id" integer NOT NULL, "pokemon_type_id" integer NOT NULL, CONSTRAINT "PK_cd8e6cb98cfa274534bc901a457" PRIMARY KEY ("pokemon_id", "pokemon_type_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_73c6b1b823f956eb2ccead28fa" ON "pokemon_pokemon_types" ("pokemon_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_020210fe090e007834836369e8" ON "pokemon_pokemon_types" ("pokemon_type_id") `);
        await queryRunner.query(`CREATE TABLE "pokemon_abilities" ("pokemon_id" integer NOT NULL, "ability_id" integer NOT NULL, CONSTRAINT "PK_bdb42882f9e17a1310724be8edd" PRIMARY KEY ("pokemon_id", "ability_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_79285c27f5b8e80eb731b1f29b" ON "pokemon_abilities" ("pokemon_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_edbe6892e439a30283707b53d0" ON "pokemon_abilities" ("ability_id") `);
        await queryRunner.query(`CREATE TABLE "pokemon_generations" ("pokemon_id" integer NOT NULL, "generation_id" integer NOT NULL, CONSTRAINT "PK_1d27ada913206e311bfb4f87e08" PRIMARY KEY ("pokemon_id", "generation_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_66483ca68ef5a02c0d9dd8db12" ON "pokemon_generations" ("pokemon_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_821a4a5e8657e94256d265cbd8" ON "pokemon_generations" ("generation_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "pokemon_move" ADD CONSTRAINT "FK_3fa42e7c13f7b84252bf652a88b" FOREIGN KEY ("generation_id") REFERENCES "generation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "pokemon_pokemon_types" ADD CONSTRAINT "FK_73c6b1b823f956eb2ccead28fa1" FOREIGN KEY ("pokemon_id") REFERENCES "pokemon"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "pokemon_pokemon_types" ADD CONSTRAINT "FK_020210fe090e007834836369e8b" FOREIGN KEY ("pokemon_type_id") REFERENCES "pokemon_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pokemon_abilities" ADD CONSTRAINT "FK_79285c27f5b8e80eb731b1f29ba" FOREIGN KEY ("pokemon_id") REFERENCES "pokemon"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "pokemon_abilities" ADD CONSTRAINT "FK_edbe6892e439a30283707b53d02" FOREIGN KEY ("ability_id") REFERENCES "ability"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pokemon_generations" ADD CONSTRAINT "FK_66483ca68ef5a02c0d9dd8db12c" FOREIGN KEY ("pokemon_id") REFERENCES "pokemon"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "pokemon_generations" ADD CONSTRAINT "FK_821a4a5e8657e94256d265cbd81" FOREIGN KEY ("generation_id") REFERENCES "generation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "pokemon_generations" DROP CONSTRAINT "FK_821a4a5e8657e94256d265cbd81"`);
        await queryRunner.query(`ALTER TABLE "pokemon_generations" DROP CONSTRAINT "FK_66483ca68ef5a02c0d9dd8db12c"`);
        await queryRunner.query(`ALTER TABLE "pokemon_abilities" DROP CONSTRAINT "FK_edbe6892e439a30283707b53d02"`);
        await queryRunner.query(`ALTER TABLE "pokemon_abilities" DROP CONSTRAINT "FK_79285c27f5b8e80eb731b1f29ba"`);
        await queryRunner.query(`ALTER TABLE "pokemon_pokemon_types" DROP CONSTRAINT "FK_020210fe090e007834836369e8b"`);
        await queryRunner.query(`ALTER TABLE "pokemon_pokemon_types" DROP CONSTRAINT "FK_73c6b1b823f956eb2ccead28fa1"`);
